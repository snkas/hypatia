...
# Output
set output "pdf/isls_vs_gs_relays_time_vs_tcp_rate.pdf"
...
plot    "../../../ns3_experiments/a_b/data/kuiper_630_isls_1180_to_1177_with_TcpNewReno_at_10_Mbps/tcp_flow_0_rate_in_intervals.csv" using ($2/1000000000):($3) title "Only ISLs" w steps ls 1, \
        "../../../ns3_experiments/a_b/data/kuiper_630_gs_relays_1156_to_1232_with_TcpNewReno_at_10_Mbps/tcp_flow_0_rate_in_intervals.csv" using ($2/1000000000):($3) title "Only GS relays" w steps ls 2, \
