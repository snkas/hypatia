...
# Output
set output "pdf/plot_specific_tm_time_vs_available_bandwidth_over_path.pdf"
...
plot    "../../ns3_experiments/traffic_matrix/data/run_specific_tm_pairing_kuiper_isls_static/pair_path_utilization_at_1s_1174_to_1229.txt" using ($1/1000000000):(10.0 - $2*10.0) title "" w lp ls 2, \
        "../../ns3_experiments/traffic_matrix/data/run_specific_tm_pairing_kuiper_isls_moving/pair_path_utilization_at_1s_1174_to_1229.txt" using ($1/1000000000):(10.0 - $2*10.0) title "" w lp ls 1, \
