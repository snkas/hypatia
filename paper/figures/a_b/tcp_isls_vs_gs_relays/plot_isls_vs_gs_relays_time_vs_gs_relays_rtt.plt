...
# Output
set output "pdf/isls_vs_gs_relays_time_vs_gs_relays_rtt.pdf"
...
plot    "../../../ns3_experiments/a_b/data/kuiper_630_gs_relays_1156_to_1232_with_TcpNewReno_at_10_Mbps/tcp_flow_0_rtt.csv" using ($2/1000000000):($3/1000000) title "Only GS relays" w steps ls 2, \
