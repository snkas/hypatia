...
# Output
set output "pdf/presentation_ecdf_num_path_changes.pdf"

#####################################
### AXES AND KEY

# Axes labels
set xlabel "# of path changes" # Markup: e.g. 99^{th}, {/Symbol s}, {/Helvetica-Italic P}
...
plot    "../../../satgenpy_analysis/data/telesat_1015_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/path/data/ecdf_pairs_num_path_changes.txt" using ($1):($2) title "Telesat T1"  with steps ls 3, \
        "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/path/data/ecdf_pairs_num_path_changes.txt" using ($1):($2) title "Kuiper K1"  with steps ls 1, \
        "../../../satgenpy_analysis/data/starlink_550_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/path/data/ecdf_pairs_num_path_changes.txt" using ($1):($2) title "Starlink S1"  with steps ls 2, \
