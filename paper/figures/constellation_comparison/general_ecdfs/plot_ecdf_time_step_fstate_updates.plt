...
# Output
set output "pdf/ecdf_time_step_num_fstate_updates.pdf"

#####################################
### AXES AND KEY

# Axes labels
set xlabel "# of fstate updates in a time step" # Markup: e.g. 99^{th}, {/Symbol s}, {/Helvetica-Italic P}
...
plot    "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/50ms_for_200s/path/data/ecdf_time_step_num_fstate_updates.txt" using ($1):($2) title "50ms"  with steps ls 1, \
        "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/path/data/ecdf_time_step_num_fstate_updates.txt" using ($1):($2) title "100ms"  with steps ls 2, \
        "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/1000ms_for_200s/path/data/ecdf_time_step_num_fstate_updates.txt" using ($1):($2) title "1000ms"  with steps ls 3, \
