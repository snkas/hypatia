...
# Output
set output "pdf/time_vs_multiple_rtt_pair_b.pdf"
...
set label "TCP" at 17,165 textcolor rgb "#2f9e37"
set label "Pings," at 40,30 textcolor rgb "#fc7f2b"
set label "Computed" at 70,30 textcolor rgb "#2177b0"
...
plot    "../../../ns3_experiments/a_b/data/kuiper_630_isls_1173_to_1241_with_TcpNewReno_at_10_Mbps/tcp_flow_0_rtt.csv" using ($2/1000000000):($3/1000000) title "TCP" w steps ls 3, \
        "../../../ns3_experiments/a_b/data/kuiper_630_isls_1173_to_1241_pings/ping_1173_to_1241_rtt.csv" using ($3/1000000000):($4/1000000) title "Pings" w steps ls 2, \
        "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/manual/data/networkx_rtt_1173_to_1241.txt" using ($1/1000000000):($2/1000000) title "Computed" w steps ls 1, \
