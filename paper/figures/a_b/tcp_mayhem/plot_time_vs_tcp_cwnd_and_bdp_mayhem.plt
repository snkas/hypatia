...
# Output
set output "pdf/time_vs_tcp_cwnd_and_bdp_mayhem.pdf"
...
set label "NewReno CWND" at 60,240 textcolor rgb "#2177b0"
set label "Vegas CWND" at 50,50 textcolor rgb "#fc7f2b"
set label "BDP" at 120,82 textcolor rgb "#2f9e37"

#####################################
### PLOTS
set datafile separator ","
plot    "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/manual/data/networkx_rtt_1174_to_1229.txt" using ($1/1000000000):($2 / 1000000000 * 1250000 / 1380) title "BDP" w steps ls 3, \
        "../../../ns3_experiments/a_b/data/kuiper_630_isls_1174_to_1229_with_TcpNewReno_at_10_Mbps/tcp_flow_0_cwnd.csv" using ($2/1000000000):($3/1380) title "NewReno CWND" w steps ls 1, \
        "../../../ns3_experiments/a_b/data/kuiper_630_isls_1174_to_1229_with_TcpVegas_at_10_Mbps/tcp_flow_0_cwnd.csv" using ($2/1000000000):($3/1380) title "Vegas CWND" w steps ls 2, \
