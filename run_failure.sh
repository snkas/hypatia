...
src=0 # Paris
dest=76 # Moscow
constellation_name="starlink_550_failure_1_$isls_choice_ground_stations_$gs_choice_algorithm_$algorithm"
...
cd ../../satgenpy
python -m satgen.post_analysis.main_print_graphical_routes_and_rtt_failure ../out ../paper/satellite_networks_state/gen_data/$constellation_name
