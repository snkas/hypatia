...
# Output
set output "pdf/ecdf_min_rtt.pdf"

#####################################
### AXES AND KEY

# Axes labels
set xlabel "Min. RTT (ms)" # Markup: e.g. 99^{th}, {/Symbol s}, {/Helvetica-Italic P}
...
plot    "../../../satgenpy_analysis/data/telesat_1015_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/rtt/data/ecdf_pairs_min_rtt_ns.txt" using ($1/1000000):($2) title "Telesat T1"  with steps ls 3, \
        "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/rtt/data/ecdf_pairs_min_rtt_ns.txt" using ($1/1000000):($2) title "Kuiper K1"  with steps ls 1, \
        "../../../satgenpy_analysis/data/starlink_550_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/rtt/data/ecdf_pairs_min_rtt_ns.txt" using ($1/1000000):($2) title "Starlink S1"  with steps ls 2, \
