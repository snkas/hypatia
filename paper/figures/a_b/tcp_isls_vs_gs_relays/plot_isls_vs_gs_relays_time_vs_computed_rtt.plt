...
# Output
set output "pdf/isls_vs_gs_relays_time_vs_computed_rtt.pdf"
...
set label "Over GS relays" at 10,27.5 textcolor rgb "#fc7f2b"
set label "Over ISLs" at 10,19.5 textcolor rgb "#2177b0"

#####################################
### PLOTS
set datafile separator ","
plot    "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/manual/data/networkx_rtt_1180_to_1177.txt" using ($1/1000000000):($2 / 1000000) title "" w steps ls 1, \
        "../../../satgenpy_analysis/data/kuiper_630_isls_none_ground_stations_paris_moscow_grid_algorithm_free_one_only_gs_relays/100ms_for_200s/manual/data/networkx_rtt_1156_to_1232.txt" using ($1/1000000000):($2 / 1000000) title "" w steps ls 2, \
