...
# Output
set output "pdf/time_vs_tcp_cwnd_and_bdp_plus_queue_pair_c.pdf"
...
set label "BDP+Q" at 12,180 textcolor rgb "#2177b0"
set label "CWND" at 20,60 textcolor rgb "#fc7f2b"

#####################################
### PLOTS
set datafile separator ","
plot    "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/manual/data/networkx_rtt_1170_to_1252.txt" using ($1/1000000000):($2 / 1000000000 * 1250000 / 1380 + 100) title "BDP + Q" w steps ls 1, \
        "../../../ns3_experiments/a_b/data/kuiper_630_isls_1170_to_1252_with_TcpNewReno_at_10_Mbps/tcp_flow_0_cwnd.csv" using ($2/1000000000):($3/1380) title "CWND" w steps ls 2, \
