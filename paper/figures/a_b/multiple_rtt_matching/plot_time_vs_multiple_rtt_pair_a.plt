...
# Output
set output "pdf/time_vs_multiple_rtt_pair_a.pdf"
...
set object 2 rect from 155.4,0 to 165.2,250 fc rgb "#77e88787" lw 1 fs noborder # fs solid 0

set label "TCP" at 17,200 textcolor rgb "#2f9e37"
set label "Pings," at 40,90 textcolor rgb "#fc7f2b"
set label "Computed" at 70,90 textcolor rgb "#2177b0"
...
plot    "../../../ns3_experiments/a_b/data/kuiper_630_isls_1174_to_1229_with_TcpNewReno_at_10_Mbps/tcp_flow_0_rtt.csv" using ($2/1000000000):($3/1000000) title "TCP" w steps ls 3, \
        "../../../ns3_experiments/a_b/data/kuiper_630_isls_1174_to_1229_pings/ping_1174_to_1229_rtt.csv" using ($3/1000000000):($4/1000000) title "Pings" w steps ls 2, \
        "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/manual/data/networkx_rtt_1174_to_1229.txt" using ($1/1000000000):($2/1000000) title "Computed" w steps ls 1, \
