...
# Output
set output "pdf/presentation_time_vs_multiple_rtt_pair_a_computed.pdf"
...
plot    "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/manual/data/networkx_rtt_1174_to_1229.txt" using ($1/1000000000):($2/1000000) title "Computed" w steps ls 1, \
