...
# Output
set output "pdf/time_vs_tcp_rate_pair_a.pdf"
...
plot    "../../../ns3_experiments/a_b/data/kuiper_630_isls_1174_to_1229_with_TcpNewReno_at_10_Mbps/tcp_flow_0_rate_in_intervals.csv" using ($2/1000000000):($3) title "" w steps ls 1, \
