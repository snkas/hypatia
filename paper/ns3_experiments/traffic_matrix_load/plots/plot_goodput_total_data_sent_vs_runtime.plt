...
plot    "../data/traffic_goodput_total_data_sent_vs_runtime.csv" using ($2 / 1e9 * 8):(stringcolumn(1) eq "tcp" ? $3 / 1e9 : 1/0) title "TCP" w points ls 1, \
        "../data/traffic_goodput_total_data_sent_vs_runtime.csv" using ($2 / 1e9 * 8):(stringcolumn(1) eq "udp" ? $3 / 1e9 : 1/0) title "UDP" w points ls 2, \
