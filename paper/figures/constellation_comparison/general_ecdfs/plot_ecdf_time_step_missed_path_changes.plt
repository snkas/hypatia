...
# Output
set output "pdf/ecdf_time_step_missed_path_changes.pdf"

#####################################
### AXES AND KEY

# Axes labels
set xlabel "# of path changes missed" # Markup: e.g. 99^{th}, {/Symbol s}, {/Helvetica-Italic P}
...
plot    "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/200s/path/data/ecdf_pairs_50ms_missed_path_changes.txt" using ($1):($2) title "50ms (Baseline)"  with steps ls 1, \
        "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/200s/path/data/ecdf_pairs_100ms_missed_path_changes.txt" using ($1):($2) title "100ms"  with steps ls 2, \
        "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/200s/path/data/ecdf_pairs_1000ms_missed_path_changes.txt" using ($1):($2) title "1000ms"  with steps ls 3, \
