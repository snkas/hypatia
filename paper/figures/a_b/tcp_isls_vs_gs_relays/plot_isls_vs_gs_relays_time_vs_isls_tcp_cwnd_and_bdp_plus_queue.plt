...
# Output
set output "pdf/isls_vs_gs_relays_time_vs_isls_tcp_cwnd_and_bdp_plus_queue.pdf"
...
set label "CWND" at 10,50 textcolor rgb "#2177b0"
set label "BDP+Q" at 50,134 textcolor rgb "#2f9e37"
set label "BDP" at 75,30 textcolor rgb "#d42a2d"

#####################################
### PLOTS
set datafile separator ","
plot    "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/manual/data/networkx_rtt_1180_to_1177.txt" using ($1/1000000000):($2 / 1000000000 * 1250000 / 1380 + 100) title "BDP+Q" w steps ls 3, \
        "../../../satgenpy_analysis/data/kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_one_only_over_isls/100ms_for_200s/manual/data/networkx_rtt_1180_to_1177.txt" using ($1/1000000000):($2 / 1000000000 * 1250000 / 1380) title "BDP" w steps ls 4, \
        "../../../ns3_experiments/a_b/data/kuiper_630_isls_1180_to_1177_with_TcpNewReno_at_10_Mbps/tcp_flow_0_cwnd.csv" using ($2/1000000000):($3/1380) title "Only ISLs CWND" w steps ls 1, \
